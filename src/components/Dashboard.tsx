...
import { Ghost, Loader2, Plus, Trash, MessageSquare } from "lucide-react";
        ...
        <ul className="mt-8 grid grid-cols-1 gap-6 divide-y divide-zinc-200 md:grid-cols-2 lg:grid-cols-3">
          {files
            ...
            .map((file) => (
              <li
                key={file.id}
                className="col-sspan-1 divide-y divide-gray-200 rounded-lg bg-white shadow transition hover:shadow-lg"
              >
                <Link
